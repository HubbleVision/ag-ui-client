...
import OriginalScenarioExample from "./components/OriginalScenarioExample";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen p-8 max-w-5xl mx-auto bg-gray-900">
      <header className="mb-10 text-center">
        <h1 className="text-3xl font-bold mb-3 text-white">
          AI Agent UI Orchestration
        </h1>
        <p className="text-gray-300 max-w-2xl mx-auto">
          Demonstrating how AI Agents can orchestrate UI interactions through
          serializable event chains
        </p>
        <div className="flex gap-4 justify-center mt-4">
          <button
            onClick={() => setShowInfo(!showInfo)}
            className="px-4 py-2 bg-indigo-800 hover:bg-indigo-700 text-indigo-200 rounded-full text-sm font-medium transition-colors"
          >
            {showInfo ? "Hide Concept" : "Show Concept"}
          </button>
          <button
            onClick={() => setShowReadme(!showReadme)}
            className="px-4 py-2 bg-emerald-800 hover:bg-emerald-700 text-emerald-200 rounded-full text-sm font-medium transition-colors"
          >
      ...
      {showInfo && (
        <div className="mb-8 bg-gray-800 border border-gray-700 p-5 rounded-xl">
          <h2 className="text-lg font-semibold text-indigo-300 mb-3">
            AI Agent UI Orchestration
          </h2>
          <p className="text-gray-300 mb-4">
            This project demonstrates how AI Agents can control and orchestrate
            complex UI interactions through serializable event chains.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="bg-gray-700 p-4 rounded-md shadow-sm">
              <h3 className="font-medium text-indigo-300 mb-2">The Problem</h3>
              <p className="text-gray-300 text-sm">
                AI Agents need a way to control UI beyond simple text responses.
                They need to orchestrate complex UI workflows with precise
                timing and state management.
              </p>
            </div>
            <div className="bg-gray-700 p-4 rounded-md shadow-sm">
              <h3 className="font-medium text-indigo-300 mb-2">The Solution</h3>
              <p className="text-gray-300 text-sm">
                UIBridge provides a serializable event chain API that AI Agents
                can use to create, schedule, and execute complex UI
                interactions.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 bg-gray-800 p-6 rounded-xl shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-slate-600 mb-4">
              Below is a demonstration of an AI Agent orchestrating a task
              management interface. The Agent can create, update, and complete
              tasks through serializable event chains.
            </p>
        ...
        <div className="bg-slate-800 p-5 rounded-xl shadow-sm">
          ...
          <p className="text-slate-400 text-sm mb-4">
            This log shows the events being executed by the UI orchestration
            system, as if they were being directed by an AI Agent.
          </p>
      ...
      {/* State synchronization original scenario problem demonstration */}
      <div className="mt-12">
        <OriginalScenarioExample />
      </div>

      {/* State synchronization solution demonstration */}
      <div className="mt-12">
        <SimpleStateExample />
      </div>
    </main>
